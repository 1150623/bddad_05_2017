...
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A17', 1, 117, 'Portagem Tradicional A17 - Nó com A1');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A17', 2, 46, 'Portagem Tradicional A17 - Nó com A13');
...
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A6', 1, 13, 'Portagem Tradicional A6 - Nó com A18');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A6', 2, 99, 'Portagem Tradicional A6 - Nó com A12');

insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A7', 1, 5, 'Portagem Tradicional A7 - Nó com A5');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A7', 2, 20, 'Portagem Tradicional A7 - Nó com A2');

insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A8', 1, 45, 'Portagem Tradicional A8 - Nó com A9');

insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A9', 1, 43, 'Portagem Tradicional A9 - Nó com A8');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A9', 2, 86, 'Portagem Tradicional A9 - Nó com A20');

insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A10', 1, 71, 'Portagem Tradicional A10 - Nó com A16');

insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A16', 1, 16, 'Portagem Tradicional A16 - Nó com A10');
...
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A18', 1, 13, 'Portagem Tradicional A18 - Nó com A14');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A18', 2, 14, 'Portagem Tradicional A18 - Nó com A6');

insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A19', 1, 14, 'Portagem Tradicional A19 - Nó com A15');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A19', 2, 17, 'Portagem Tradicional A19 - Nó com A13');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A19', 3, 125, 'Portagem Tradicional A19 - Nó com A5');

insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A20', 1, 2, 'Portagem Tradicional A20 - Nó com A9');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A20', 2, 53, 'Portagem Tradicional A20 - Nó com A11');
insert into PortagemTradicional (CODAUTOESTRADA, CODPORTTRADICIONAL, QUILOMETRO, DESCRICAO) values ('A20', 3, 63, 'Portagem Tradicional A20 - Nó com A2');
