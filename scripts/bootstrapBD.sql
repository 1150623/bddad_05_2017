...
insert into LINHAPAGAMENTOSPORTAGENSTRADICIONAIS (NRREGSAIDA, NRSERIEDISPOSITIVO, VALOR, DATAEMISSAO) values (4, );
insert into LINHAPAGAMENTOSPORTAGENSTRADICIONAIS (NRREGSAIDA, NRSERIEDISPOSITIVO, VALOR, DATAEMISSAO) values (5, );
...
insert into REGISTOSAIDA (NRREGISTOENTRADA, CODPORTTRADICIONAL, CODAUTOESTRADA, MATRICULAVEICULO, DATA, ESTADODISPOSITIVO) 
              values (6,  2,'A2','00-EL-85',TO_TIMESTAMP('2016-02-15 12:43:02', 'YYYY-MM-DD HH24:MI:SS'), 1);
insert into REGISTOSAIDA (NRREGISTOENTRADA, CODPORTTRADICIONAL, CODAUTOESTRADA, MATRICULAVEICULO, DATA, ESTADODISPOSITIVO) 
              values (4, 3, 'A1','00-KK-00',TO_TIMESTAMP('2017-10-07 04:34:02', 'YYYY-MM-DD HH24:MI:SS'), 1);
insert into REGISTOSAIDA (NRREGISTOENTRADA, CODPORTTRADICIONAL, CODAUTOESTRADA, MATRICULAVEICULO, DATA, ESTADODISPOSITIVO) 
              values (5, 1, 'A4','46-OP-85',TO_TIMESTAMP('2017-07-10 09:59:02', 'YYYY-MM-DD HH24:MI:SS'), 1);
