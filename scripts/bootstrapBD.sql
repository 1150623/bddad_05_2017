...
insert into Cliente (NIF, MORADA, NOME, TIPOCLIENTE, PONTUACAOACUMULADA, PONTUACAOSALDO, data_atualizacao) values (123456789, 'Rua 1','Tiago', 'Gold', 3120, 2696, TO_TIMESTAMP('2016-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'));

insert into Cliente (NIF, MORADA, NOME, TIPOCLIENTE, PONTUACAOACUMULADA, PONTUACAOSALDO, data_atualizacao) values (159753698, 'Rua 2','Ana', 'Gold', 1564, 1231, TO_TIMESTAMP('2016-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'));

insert into Cliente (NIF, MORADA, NOME, TIPOCLIENTE, PONTUACAOACUMULADA, PONTUACAOSALDO, data_atualizacao) values (958412587, 'Rua 3','Maria', 'Gold', 3560, 3560, TO_TIMESTAMP('2016-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'));

insert into Cliente (NIF, MORADA, NOME, TIPOCLIENTE, PONTUACAOACUMULADA, PONTUACAOSALDO, data_atualizacao) values (658523658, 'Rua 4','Rodrigo', 'Gold', 1251, 1000, TO_TIMESTAMP('2016-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'));

insert into Cliente (NIF, MORADA, NOME, TIPOCLIENTE, PONTUACAOACUMULADA, PONTUACAOSALDO, data_atualizacao) values (424252586, 'Rua 5','Guilherme', 'Silver', 4503, 3250, TO_TIMESTAMP('2016-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'));

insert into Cliente (NIF, MORADA, NOME, TIPOCLIENTE, PONTUACAOACUMULADA, PONTUACAOSALDO, data_atualizacao) values (956485231, 'Rua 6','Pedro', 'Silver', 8651, 2300, TO_TIMESTAMP('2017-02-05 10:25:19', 'YYYY-MM-DD HH24:MI:SS'));

insert into Cliente (NIF, MORADA, NOME, TIPOCLIENTE, PONTUACAOACUMULADA, PONTUACAOSALDO, data_atualizacao) values (123569874, 'Rua 7','Joao', 'Silver', 568, 113, TO_TIMESTAMP('2017-04-20 16:39:19', 'YYYY-MM-DD HH24:MI:SS'));

insert into Cliente (NIF, MORADA, NOME, TIPOCLIENTE, PONTUACAOACUMULADA, PONTUACAOSALDO, data_atualizacao) values (987654321, 'Rua 8','Joaquim', 'Silver', 2000, 1850, TO_TIMESTAMP('2017-06-12 15:31:29', 'YYYY-MM-DD HH24:MI:SS'));
...
insert into REGISTOENTRADA (CODAUTOESTRADA, CODPORTTRADICIONAL, MATRICULAVEICULO, DATAREG, ESTADODISPOSITIVO) values ('A1', 3, '88-LL-88',TO_TIMESTAMP('2017-10-14 03:12:02', 'YYYY-MM-DD HH24:MI:SS'), 1);
...
insert into REGISTOENTRADA (CODAUTOESTRADA, CODPORTTRADICIONAL, MATRICULAVEICULO, DATAREG, ESTADODISPOSITIVO) values ('A2', 2, '00-EL-85',TO_TIMESTAMP('2016-02-15 12:12:02', 'YYYY-MM-DD HH24:MI:SS'), 0);
...
insert into REGISTOSAIDA (NRREGISTOENTRADA, CODPORTTRADICIONAL, CODAUTOESTRADA, MATRICULAVEICULO, DATA, ESTADODISPOSITIVO) values (3, 4, 'A1','88-LL-88',TO_TIMESTAMP('2017-10-14 03:22:05','YYYY-MM-DD HH24:MI:SS'),1);
...
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(1, TO_TIMESTAMP('2016-01-02 12:32:55', 'YYYY-MM-DD HH24:MI:SS'), 1, 3.5, 1);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(2, TO_TIMESTAMP('2016-01-02 12:35:12', 'YYYY-MM-DD HH24:MI:SS'), 2,1.95, 2);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(3, TO_TIMESTAMP('2017-05-02 21:32:00', 'YYYY-MM-DD HH24:MI:SS'), 6,1.76, 4);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(4, TO_TIMESTAMP('2017-01-02 12:41:11', 'YYYY-MM-DD HH24:MI:SS'),1,2.34,5);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(5, TO_TIMESTAMP('2016-01-02 9:12:52', 'YYYY-MM-DD HH24:MI:SS'), 4,1.05,7);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(6, TO_TIMESTAMP('2016-01-02 11:55:55', 'YYYY-MM-DD HH24:MI:SS'), 5,8.563, 8);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(7, TO_TIMESTAMP('2017-01-02 01:02:03', 'YYYY-MM-DD HH24:MI:SS'), 1,1.35, 9);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(8, TO_TIMESTAMP('2017-01-02 02:14:16', 'YYYY-MM-DD HH24:MI:SS'), 8,4.369, 10);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(9, TO_TIMESTAMP('2017-01-02 09:13:20', 'YYYY-MM-DD HH24:MI:SS'), 14,1.25, 12);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(10, TO_TIMESTAMP('2017-01-02 00:00:41', 'YYYY-MM-DD HH24:MI:SS'), 12,1.5, 13);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(11, TO_TIMESTAMP('2017-01-02 03:14:11', 'YYYY-MM-DD HH24:MI:SS'), 1,1.658,14);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(12, TO_TIMESTAMP('2017-01-02 03:25:26', 'YYYY-MM-DD HH24:MI:SS'), 1,1.6587,15);
insert into LINHAPAGAMENTOPASSAGEMPORTICO (IDPAGAMENTO, DATAEMISSAO, NRSERIEDISPOSITIVO, VALORTOTAL, NRPASSAGEM) values(13, TO_TIMESTAMP('2017-01-02 11:11:11', 'YYYY-MM-DD HH24:MI:SS'), 9,7.1256,16);
